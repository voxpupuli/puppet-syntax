...
describe "syntax:manifests" do
  ...
  context "manifest with errors" do
    ...
    describe "always fails regardless that fail_on_deprecation_notices is set to true" do
  ...
  context "manifest with deprecation notices" do
    ...
    describe "and fail_on_deprecation_notices is set to default" do
      it_behaves_like "a failing rake task"
    end

    describe "and fail_on_deprecation_notices is set to true" do
      PuppetSyntax.fail_on_deprecation_notices = true
      it_behaves_like "a failing rake task"
    end

    describe "and fail_on_deprecation_notices is set to false" do
      PuppetSyntax.fail_on_deprecation_notices = true
      it_behaves_like "a failing rake task"
    end
  end
